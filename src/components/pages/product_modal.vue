            ...
            <p class="login__input-error" v-if="errors && errors.length">
             ...
             <Field
              ...
              <select id="group" class="form__select" v-model="forms.group">
                <option selected hidden value="">Select product group</option>
                <option :value="item.title" v-for="item in $store?.state?.groups" :key="item.id">{{ item.title }}</option>
              </select>
            <p class="login__input-error" v-if="errors && errors.length">
               {{ errors[0] }}
             </p>
             ...
             <Field
              ...
              <select id="brand" class="form__select" v-model="forms.brand">
                ...
                <option :value="item.title" v-for="item in $store?.state?.brands" :key="item.id">{{ item.title }}</option>
              </select>
            <p class="login__input-error" v-if="errors && errors.length">
               {{ errors[0] }}
             </p>
